        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-default">
                    <div class="box-header no-border text-center">
                        <h3 class="box-title">Tải nhanh</h3>
                    ...
                    <div class="box-body">
                        <form action="#" class="text-center" style="width: 30vw;margin: 0 auto;" onsubmit="return gotoUpload()">
                            <div class="form-group">
                                <label for="">Chọn {{ucfirst(config('settings.document_label_singular'))}}</label>
            ...
            <div class="col-md-4">
                <div class="info-box bg-yellow">
                    ...
                    Tổng {{ucfirst(config('settings.tags_label_plural'))}} trong hệ thống
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <div class="info-box bg-green">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="progress-description">
                    Chứa {{$filesCounts}} {{ucfirst(config('settings.file_label_plural'))}}
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-sm-12">
                <div class="box box-default">
                    <div class="box-header no-border">
                        <h3 class="box-title">Hoạt động</h3>
