...
class TagController extends AppBaseController
{
    ...
    public function store(CreateTagRequest $request)
    {
        ...
        Flash::success(ucfirst(config('settings.tags_label_singular')) . " đã lưu thành công.");
    ...
    public function show($id)
    {
        ...
        if (empty($tag)) {
            Flash::error(ucfirst(config('settings.tags_label_singular')) . ' không tìm thấy');
    ...
    public function update($id, UpdateTagRequest $request)
    {
        ...
        Flash::success(ucfirst(config('settings.tags_label_singular')) . ' cập nhật thành công.');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            Flash::error('This ' . config('settings.tags_label_singular') . ' has ' . config('settings.document_label_plural') . '. Hãy xóa ' . config('settings.document_label_plural') . ' và thử lại lần sau.');
            return redirect(route('tags.index'));
        }

        Flash::success(ucfirst(config('settings.tags_label_singular')) . ' đã xóa thành công.');
        return redirect(route('tags.index'));
    }
}
